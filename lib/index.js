import { defineComponent, openBlock, createElementBlock, renderSlot, createElementVNode, ref, onBeforeMount, computed, watch, resolveComponent, createBlock, unref, withCtx, Fragment, renderList, createVNode, createCommentVNode, createTextVNode, toDisplayString, nextTick } from 'vue';

const _hoisted_1$2 = { class: "mu_Button" };
const __default__$1 = {
    name: 'clButton',
};
...
script$2.__file = "packages/components/button/src/index.vue";

script$2.install = (app) => {
    app.component(script$2.name, script$2);
};
const InMeAccordionItem = script$2;
...
const components = [InMeAccordionItem, _clYamlEdit];
...
export { InMeAccordionItem as ClButton, _clYamlEdit as clYamlEdit, index as default };
